...
?>
<section <?php if (isset($atts['custom_id'])) echo "id='{$atts['custom_id']}'";?>
class="fw-main-row <?php if(isset($atts['custom_class'])) echo $atts['custom_class'];?> <?php echo esc_attr($section_extra_classes) ?>" 
